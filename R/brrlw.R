...
#' @param conditions the replicates to be analyzed, e.g. `list(i = 1:5, weights = c("w_math_student_final", "w_math_student_r1")`
...
#'
#' @export
brrlw <- function(statistic, data, weights, conditions, i = NULL, r = NULL, .progress = TRUE, .verbose = TRUE) {
